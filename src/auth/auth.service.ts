...
export class AuthService {
    ...
    async register(
        ...
        const user = await this.createUser(registerDto.firstName, registerDto.lastName, registerDto.email, hashedPassword);
    ...
    async login(loginDto: LoginDto): Promise<StandardResponse<TokenResponseDto>> {
        ...
        return {
            data: new TokenResponseDto(
                this.generateAuthToken(account),
            ),
            error: false,
        };
    }
  ...
  `,
    ...
    async validateGoogleAccount(googleAccount: GoogleAccountDto): Promise<UserEntity | ModeratorEntity | AdminEntity> {
        ...
        return this.createUser(googleAccount.firstName, googleAccount.lastName, googleAccount.email, '');
    }

    private async createUser(firstName: string, lastName: string, email: string, hashedPassword: string) {
